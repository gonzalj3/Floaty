...
open class Floaty: UIView {
    ...
    @objc open func open() {
        ...
        if(items.count > 0){
            ...
            UIAccessibility.post(notification: UIAccessibilityLayoutChangedNotification, argument: items.first);
        }
    ...
    @objc open func close() {
        ...
        if(items.count > 0){
            ...
            UIAccessibility.post(notification: UIAccessibilityLayoutChangedNotification, argument: self);
        }
    ...
    fileprivate func setObserver() {
        NotificationCenter.default.addObserver(self, selector: #selector(deviceOrientationDidChange(_:)), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
